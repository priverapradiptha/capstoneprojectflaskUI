...
def index():
    ...
    top2app = df2[['App','Reviews']].groupby(['App']).agg({
        'Reviews' : 'sum'
    }).sort_values(by='Reviews', ascending=False).head(3)
    X = top2app.index
    Y = (top2app['Reviews']/1000000).values
    my_colors = 'rgbkymc'
    # bagian ini digunakan untuk membuat kanvas/figure
    ...
    # bagian ini digunakan untuk menyimpan plot dalam format image.png
    plt.savefig('top3app.png',bbox_inches="tight") 
